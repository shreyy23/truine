<template>
  <div class="flex items-center justify-center relative overflow-x-hidden">
    <!-- Footer Content -->
    <div class="w-full h-auto xl:h-[610px] flex flex-col xl:flex-row justify-start items-end relative z-10">
      <!-- Left Section -->
      <div
        class="w-full xl:w-1/2 h-auto xl:h-[610px] px-10 xl:px-[100px] py-20 xl:py-[85px] bg-[#339abc] xl:rounded-tr-xl flex flex-col justify-start items-start gap-2.5 overflow-hidden mobile-no-radius">
        <div class="w-full h-auto flex flex-col justify-start items-start gap-10">
          <div class="w-full h-auto flex flex-col justify-start items-center gap-4">
            <div class="w-full text-white text-3xl xl:text-[54px] font-bold leading-tight xl:leading-[81px]">
         ...
         hover:bg-white transition duration-300 text-white font-bold hover:text-[#339abc]">
            Let’s Connect
          </button>
        </div>
      </div>
      ...
      <div
        ...
        <div class="w-full h-auto flex flex-col justify-start items-start gap-8">
          <div class="w-full flex flex-col xl:flex-row justify-between items-start gap-8">
            <!-- Pages Section -->
          ...
          <!-- Contact Section -->
          <div class="w-full flex flex-col justify-start items-start gap-8">
            <div class="w-full flex flex-col xl:flex-row justify-between gap-8">
...
<style scoped>
/* Remove border radius on mobile view for the left section */
